  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="StyleAura shares clothing ideas, cosmetics recommendations, skincare basics, makeup tips, and budget-friendly style inspiration."
        />
        <meta
          property="og:title"
          content="StyleAura - Clothing & Cosmetics Blog"
        />
        <meta
          property="og:description"
          content="Discover outfit ideas, cosmetics picks, skincare basics, and value-focused style inspiration."
        />
      ...
      <section className="relative min-h-[64vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={HERO_BG}
            alt="StyleAura clothing and cosmetics"
        ...
        <div className="relative container-custom text-white z-10 py-20">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/85 mb-8 max-w-2xl">
              StyleAura helps you discover the best clothing styles, skincare
              essentials, makeup tips, and trending cosmetics that fit your
            ...
            <div className="flex items-center gap-3 bg-white/15 backdrop-blur-md border border-white/30 rounded-2xl p-2 max-w-xl mx-auto">
              <FiSearch
                size={20}
                className="ml-3 text-white/70 flex-shrink-0"
              />
              <input
                type="text"
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              ...
              <Link
                to="/outfits"
                className="btn bg-white/20 backdrop-blur text-white border border-white/30 hover:bg-white/30"
              >
                Beauty
              </Link>
              <Link
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg
            viewBox="0 0 1440 60"
            className="w-full fill-gray-50 dark:fill-neutral-950"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Clear ideas for daily outfits, party looks, and easy pairings.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 16 }}
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Makeup and skincare recommendations selected for real-world use.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 16 }}
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Trending products and useful posts, all in one clean feed.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-8 items-stretch">
          <div className="bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800 rounded-2xl p-6 md:p-8 shadow-card">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
              Tap a style mood to switch the board. Each edit combines clothing
              direction with cosmetics or skincare details, so the inspiration
              feels complete.
            </p>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {activeBoard.notes.map((note) => (
                  <div
                    key={note}
                    className="flex items-center gap-3 rounded-xl bg-gray-50 dark:bg-neutral-950 border border-gray-100 dark:border-neutral-800 p-3"
                  >
                    <FiCheckCircle
